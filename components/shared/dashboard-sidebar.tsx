 ...
 * pattern. Nav items are supplied by the consuming dashboard layout; the user
 * menu is wired to the real session (Profile link + better-auth sign out).
 * The BoardUI ThemeToggle is omitted because the app themes via next-themes.
 */
    ...
    >
      <div className="-m-2 flex min-h-0 w-[calc(100%+16px)] flex-col gap-3 overflow-y-auto p-2 [scrollbar-width:none]">
        ...
        >
          ...
          >
            <DashboardUserMenu collapsed={collapsed} user={user} />
          </div>
          <button
            type="button"
